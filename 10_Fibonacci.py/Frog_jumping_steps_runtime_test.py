# -*- coding: utf-8 -*-
"""
Created on Sun Mar 31 12:08:53 2019
...
#方法1
print(min(timeit.repeat('Solution().Frog_jump_steps_Solution1(10)',s,number=10000)))

#方法2
print(min(timeit.repeat('Solution().Frog_jump_steps_Solution2(10)',s,number=10000)))

#方法3
print(min(timeit.repeat('Solution().Frog_jump_steps_Solution_my(10)',s,number=10000)))
